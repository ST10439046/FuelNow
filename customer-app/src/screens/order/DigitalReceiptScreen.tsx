...
function ReceiptRow({
  ...
  return (
    <View style={styles.row}>
      <Text style={[styles.rowLabel, { fontWeight: bold ? "700" : "400" }]}>
        {label}
      </Text>
      <Text style={[styles.rowValue, { fontWeight: bold ? "700" : "400" }]}>
        {value}
      </Text>
    </View>
  );
      ...
      >
        ...
        >
          ...
          <View
            style={[
              styles.successBadge,
              { backgroundColor: isWF ? "#D0D0D0" : colors.dieselGreen },
            ]}
          >
          ...
          <Text
            style={[
              {
                color: isWF ? "#CCC" : "rgba(255,255,255,0.7)",
        ...
        <Card style={styles.section}>
          ...
          >
            Dispensed at {ORDER.deliveredAt} by {ORDER.driver} from{" "}
            {ORDER.station}
          </Text>
          <Text
            style={[
        ...
        <Card style={styles.section}>
          ...
          <View style={{ gap: 6 }}>
            ...
            <View
              style={[
                styles.divider,
                { backgroundColor: isWF ? "#DDD" : colors.divider },
              ]}
            />
            <View style={styles.row}>
              <Text
          ...
          >
            ...
            >
              ...
              <Text style={{ fontFamily: "Inter_600SemiBold" }}>
                +{ORDER.loyaltyEarned} FuelPoints
              </Text>{" "}
              on this order!
            </Text>
          </View>
