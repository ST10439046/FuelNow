...
1. You will run your tests in a bit. Let's add linting first...
...
1. Install eslint
    ...
    npm install eslint
    ```
1. Add in a lint config file called `eslint.config.cjs` to the API root directory:
    ```js
...
1. Run your lint test
    ...
    npm run lint
    ```
1. Address all the errors and run the report again
...
1. Run your unit tests
    ...
    npm test
    ```
1. View the unit test coverage report at: `pulsevote-backend\coverage\lcov-report`
1. Add your own unit tests to test each API endpoint. Aim for at least 80% code coverage.