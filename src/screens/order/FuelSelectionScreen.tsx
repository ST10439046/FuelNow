    ...
    <SafeAreaView style={[styles.container, { backgroundColor: isWF ? '#F0F0F0' : colors.warmAsh }]}>
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        >
          {(['litres', 'rand'] as const).map((mode) => (
              ...
              style={[
                styles.toggleBtn,
                {
                  backgroundColor: inputMode === mode
                    ...
                    : 'transparent',
                  borderRadius: isWF ? Radius.xs : Radius.full,
                },
              ]}
            ...
            >
              ...
              >
                {mode === 'litres' ? 'Enter Litres' : 'Enter Rand Amount'}
              </Text>
            </TouchableOpacity>
          ))}
        </View>
        ...
        <Card style={styles.inputCard}>
          <Text style={[styles.label, { color: isWF ? '#333' : colors.inkLight, fontFamily: font('body'), fontSize: FontSizes.sm }]}>
            {inputMode === 'litres' ? 'Litres' : 'Rand amount (R)'}
          </Text>
          <View style={styles.inputRow}>
            <Text style={[styles.inputPrefix, { color: isWF ? '#444' : colors.petrolDeep, fontFamily: isWF ? undefined : 'Inter_600SemiBold', fontSize: FontSizes['3xl'] }]}>
        ...
        {/* Live running total */}
        <Card style={[styles.totalCard, { borderLeftWidth: 4, borderLeftColor: isWF ? '#888' : colors.ignitionAmber }]}>
